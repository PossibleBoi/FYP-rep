    ...
    useEffect(() => {
        ...
        http.get(`/user/project/${project_id}`)
            .then((response) => {
                ...
                setOtherImages(response.data.project[0].images);
        ...
        <div className="container mx-auto px-4 py-8 max-h-screen overflow-y-auto">
                ...
                <div>
                    ...
                    <div className="mb-5">
                        ...
                        <select id="genre" value={genre} onChange={handleGenreChange} className="bg-white appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-blue-500" required>
                            <option value="">Default : {project.genre}</option>
                            {genreList.map((genre) => (
            ...
            <div className="p-2 rounded-lg mb-4 bg-gray-200">
                ...
                <div className="grid grid-cols-2 gap-4">
                    <div>
                        <h3>User ID: 123</h3>
                        <p>Report: Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                    </div>
                    <div>
                        <h3>User ID: 456</h3>
                        <p>Report: Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                    </div>
                </div>
            </div>
        </div>
